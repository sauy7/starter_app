...
Rails.application.configure do
  ...
  config.middleware.use(
    ...
    email: {
      email_prefix: '[StarterApp PRODUCTION ERROR] ',
      sender_address: %("Error Notifier" <error_notifier@starter_app.com>),
      exception_recipients: [ENV.fetch('EXCEPTION_RECIPIENT_EMAIL',
                                       'it@starter_app.com')]
    },
    github: {
      prefix: '[StarterApp PRODUCTION ERROR] ',
      repo: 'github_owner/starter_app',
